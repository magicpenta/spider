...
public class HttpUtilTest {
    ...
    public void testExecuteGetRequestByCookie() {
        ...
        httpParams.setUrl("https://weibo.com/u/2036512014");
        ...
        httpParams.setNeedCookie(true);
        httpParams.setHeaderMap(headerMap);
    ...
    public void testExecuteGetRequestByProxy() {
        ...
        httpParams.setNeedProxy(true);
        httpParams.setUrl("https://www.google.com/");
        httpParams.setProxy(proxy);
        String responseBody = HttpUtil.executeGetRequest(httpParams);
        assert responseBody != null;
        System.out.println(responseBody);
    }
    ...
    public void testExecutePostRequest() {
        ...
        HttpParams httpParams = new HttpParams();
        httpParams.setUrl("http://www.pkulaw.cn/doCluster.ashx");
        httpParams.setFormParams(formParams);
