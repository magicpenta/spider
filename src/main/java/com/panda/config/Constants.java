...
public class Constants {
    ...
    public static final Integer TASK_INTERVAL = Integer.valueOf(prop.getProperty("task_interval", "10000"));
    public static final Integer TASK_STATUS_INTERVAL = Integer.valueOf(prop.getProperty("task_status_interval", "20000"));
    ...
    public static final String PROXY_SEPARATOR = prop.getProperty("proxy_separator");
    ...
    public static final String JMX_URL = prop.getProperty("jmx_url", "com.panda.service:jmx:rmi:///jndi/rmi://localhost:1099/jmxrmi");
    ...
    public static final Integer MAX_RUNNING_TIME = Integer.valueOf(prop.getProperty("max_running_time", "10"));
