...
import com.panda.util.FileUtils;

import java.io.ByteArrayInputStream;
import java.io.InputStreamReader;

/**
 * XPath com.panda.demo
 *
 * @author panda
 * @date 2017/11/18
 */
public class XPathDemo {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            parser.setFeature("common://xml.org/sax/features/namespaces", false);
            parser.setProperty(
                    "common://cyberneko.org/html/properties/default-encoding",
                    "UTF-8");
